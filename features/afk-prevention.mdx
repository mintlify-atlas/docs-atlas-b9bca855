...
6. Moves the mouse to coordinates **(778, 912)** — the position of the Eden dialogue left-option button — and clicks.
7. Moves the mouse back to its original position.
8. Restores focus to the previously active window.
