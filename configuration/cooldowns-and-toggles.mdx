...
description: "Configure item cooldown intervals, the AFK action interval, and feature toggles including OCR bypass, crafting close bypass, and per-item enable/disable flags."
---
